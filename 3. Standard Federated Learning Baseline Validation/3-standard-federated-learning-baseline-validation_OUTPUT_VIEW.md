...
OUTPUT_DIR = "grip_dffi_standard_fl_baselines_outputs"
os.makedirs(OUTPUT_DIR, exist_ok=True)
os.makedirs(os.path.join(OUTPUT_DIR, "plots"), exist_ok=True)
FEATURE_INTEL_ROUNDS = 2
ROUNDS = 15
...
fl_baselines = ['FedAvg', 'FedProx', 'SCAFFOLD', 'FedNova', 'MOON']
specs = download_dataset_specs([dict(x) for x in DATASET_SPECS])
results = [run_standard_fl_baseline(name, specs) for name in fl_baselines]
...
with open(os.path.join(OUTPUT_DIR, 'grip_dffi_standard_fl_baselines_metrics_and_curves.json'), 'w') as f:
...
![png](3-standard-federated-learning-baseline-validation_OUTPUT_VIEW_files/3-standard-federated-learning-baseline-validation_OUTPUT_VIEW_0_4.png)
    



    
![png](3-standard-federated-learning-baseline-validation_OUTPUT_VIEW_files/3-standard-federated-learning-baseline-validation_OUTPUT_VIEW_0_5.png)
    



    
![png](3-standard-federated-learning-baseline-validation_OUTPUT_VIEW_files/3-standard-federated-learning-baseline-validation_OUTPUT_VIEW_0_6.png)
    



    
![png](3-standard-federated-learning-baseline-validation_OUTPUT_VIEW_files/3-standard-federated-learning-baseline-validation_OUTPUT_VIEW_0_7.png)
